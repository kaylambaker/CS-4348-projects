...
extern void print_init_spool(uint pid);
// send message to printer to output pids spool file to printer.out
extern void print_end_spool(uint pid);
// send message to printer to write buf to pids spool file
extern void print_print(const char *buf, uint pid);
...
extern void printer_dump_spool(uint pid);
